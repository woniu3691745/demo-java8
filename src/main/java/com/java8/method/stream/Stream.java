package com.java8.method.stream;
...
public class Stream {
    ...
    private void collect() {
        List<String> collect = java.util.stream.Stream.of("a", "b", "c").collect(Collectors.toList());
     ...
     */
    private void map() {
        List<String> collect = java.util.stream.Stream.of("a", "b", "hello")
                .map(s -> s.toUpperCase())
     ...
     */
    private void filter() {
        List<String> beginningWithNumbers = java.util.stream.Stream.of("d", "1abc", "a2bc1")
    ...
    private void flatMap() {
        List<Integer> together = java.util.stream.Stream.of(asList(1, 2), asList(3, 4))
...
//                .min(Comparator.comparing(userInfo -> userInfo.getAge()))
     ...
     */
    private void reduce() {
        int count = java.util.stream.Stream.of(1, 2, 3)

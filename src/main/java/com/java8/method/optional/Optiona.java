package com.java8.method.optional;
...
public class Optiona {
    ...
    private void op3 () {
        ...
        System.out.println(op.map(UserInfo::getUserName).map(String::toUpperCase).orElse("this is empty"));
    }

    public static void main(String[] args) {

        Optiona optiona01 = new Optiona();
//        optiona01.op1();
//        optiona01.op2();
        optiona01.op3();
    }
